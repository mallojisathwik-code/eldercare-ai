        ...
        <div className="w-full max-w-md">
          <div className="rounded-3xl border border-slate-800 bg-slate-950/85 p-8 shadow-[0_25px_60px_rgba(0,0,0,0.9)] backdrop-blur-2xl">
            <div className="mb-8 text-center">
              <h1 className="text-2xl font-bold tracking-tight text-white">Create Family Account</h1>
              <p className="mt-2 text-sm text-slate-400">Set up your family dashboard to manage elder care</p>
            </div>
